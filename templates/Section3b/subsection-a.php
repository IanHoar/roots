<section class="sub-section">
	...
	<div class="sticky_section"> 
		...
		<div class="fullscreen background no-animation resettable crossfade" style="background-image:url('<?php  bloginfo('template_directory'); ?>/assets/img/3A/3E-background.jpg');" data-img-width="2200" data-img-height="1416" data-diff="100">
			<div class="content-a">
				<div class="content-b">
		...
		<div class="fullscreen background no-animation resettable crossfade" style="background-image:url('<?php  bloginfo('template_directory'); ?>/assets/img/3A/3E2-background.jpg');" data-img-width="2200" data-img-height="1416" data-diff="100">
			<div class="content-a">
				<div class="content-b">
