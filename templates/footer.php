  ...
  <div class="container-fluid">
    ...
    <div class="col-sm-3" id="dates-footer">
      ...
      <ul>
        ...
        <li>SAN FRANCISCO MARITIME NATIONAL </li>
        ...
        <li>BARKERVILLE BREWING CO.</li>
        <li>O’KEEFE RANCH AND INTERIOR HERITAGE SOCIETY</li>
        <li>QUESNEL &amp; DISTRICT MUSEUM &amp; ARCHIVES</li>
        <li>SOUTH CARIBOO HISTORICAL MUSEUM SOCIETY</li>
        <li>YALE AND DISTRICT HISTORICAL SOCIETY</li>
        <li>CITY OF VICTORIA</li>
        <li>DOWNTOWN VICTORIA BUSINESS ASSOCIATION</li>
        <li>ART GALLERY OF GREATER VICTORIA</li>
        <li>GOVERNMENT HOUSE</li>
        <li>THE BAY CENTRE</li>
        <li>GRANT KEDDIE</li>
        <li>KATE KERR</li>
        <li>KEITH SCOTT</li>
        <li>REG BECK</li>
